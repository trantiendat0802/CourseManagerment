...
public class RegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cnfPwdEdt = findViewById(R.id.idEdtConfPassword);
        ...
        registerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!pwd.equals(cnfPwd)) {
                    Toast.makeText(RegistrationActivity.this, "repassword incorect!", Toast.LENGTH_SHORT).show();
                } else if (TextUtils.isEmpty(userName) && TextUtils.isEmpty(pwd) && TextUtils.isEmpty(cnfPwd)) {
                    Toast.makeText(RegistrationActivity.this, "require", Toast.LENGTH_SHORT).show();
                } else {
